    ...
    <div className="pt-28">
      ...
      <div className="text-gray-900 font-trajan">
        <article className="bg-black/50 text-white max-w-5xl mx-auto px-6 py-16 leading-relaxed text-lg font-lato tracking-widest">
          <p className="mb-4">{translations.pl.Sabre.paragraphOne}</p>
          <div className="flex flex-col md:flex-row md:gap-8 items-start">
            ...
            <div className="w-full md:w-2/3 ">
              <p className="mb-4">{translations.pl.Sabre.paragraphTwo}</p>
              <p className="mb-4">{translations.pl.Sabre.paragraphThree}</p>
              <p className="mb-4">{translations.pl.Sabre.paragraphFour}</p>
            </div>
          </div>
        </article>
      </div>
