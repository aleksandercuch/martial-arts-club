    ...
    <div className="pt-28 ">
      ...
      <div className="text-gray-900 font-trajan">
        <article className="bg-black/50 text-white max-w-5xl mx-auto px-6 py-16 leading-relaxed text-lg font-lato tracking-widest">
          <p>{translations.en.Junior.paragraphOne}</p>
          <p className="mt-6">{translations.en.Junior.paragraphTwo}</p>
          ...
          <p>{translations.en.Junior.paragraphThree}</p>
          <p className="mt-6">{translations.en.Junior.paragraphFour}</p>
          <p className="mt-6">{translations.en.Junior.paragraphFive}</p>
