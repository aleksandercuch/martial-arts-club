    ...
    <div className="pt-28">
      ...
      <div className="text-gray-900 font-trajan">
        <article className="bg-black/50 text-white max-w-5xl mx-auto px-6 py-16 leading-relaxed text-lg font-lato tracking-widest">
          <p>{t.Junior.paragraphOne}</p>
          <p className="mt-6">{t.Junior.paragraphTwo}</p>
          ...
          <p>{t.Junior.paragraphThree}</p>
          <p className="mt-6">{t.Junior.paragraphFour}</p>
          <p className="mt-6">{t.Junior.paragraphFive}</p>
